...
namespace std {
  ...
  constexpr defer_lock_t  defer_lock { @\textit{unspecified}@ };
  constexpr try_to_lock_t try_to_lock { @\textit{unspecified}@ };
  constexpr adopt_lock_t  adopt_lock { @\textit{unspecified}@ };
...
\pnum
Type \tcode{defer_lock_t} shall not have a default constructor.
It shall be a literal type. Constant \tcode{defer_lock} shall be
initialized with an argument of literal type.

\pnum
Type \tcode{try_to_lock_t} shall not have a default constructor.
It shall be a literal type. Constant \tcode{try_to_lock} shall be
initialized with an argument of literal type.

\pnum
Type \tcode{adopt_lock_t} shall not have a default constructor.
It shall be a literal type. Constant \tcode{adopt_lock} shall be
initialized with an argument of literal type.
