...
\pnum
Type \tcode{nothrow_t} shall not have a default constructor.
...
\indexlibrary{\idxcode{what}!\tcode{bad_array_new_length}}%
\begin{itemdecl}
virtual const char* what() const noexcept;
\end{itemdecl}
...
\pnum
\throws
if \tcode{is_class<U>::value \&\& !is_final<U>::value \&\& !is_base_of<nested_exception, U>::value}
is \tcode{true},
