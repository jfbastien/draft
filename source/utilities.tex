...
namespace std {
  ...
  constexpr piecewise_construct_t piecewise_construct { @\textit{unspecified}@ };
...
\pnum
Type \tcode{piecewise_construct_t} shall not have a default constructor.
It shall be a literal type. Constant \tcode{piecewise_construct} shall be
...
namespace std {
  ...
  constexpr allocator_arg_t allocator_arg { @\textit{unspecified}@ };
...
\pnum
Type \tcode{allocator_arg_t} shall not have a default constructor.
It shall be a literal type. Constant \tcode{allocator_arg} shall be
initialized with an argument of literal type.
