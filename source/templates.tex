...
\enternote however, such a type may be aliased,
...
\begin{itemize}
\item
Each \grammarterm{template-parameter} shall appear at least once
in the \grammarterm{template-id} outside a non-deduced context.
\enterexample
\begin{codeblock}
...
\item
an injected-type-name (Clause~\ref{class}) of a class template or
...
\grammarterm{exception-specification}{s}, and non-static data member
...
whose \grammarterm{declarator-id} or \grammarterm{class-head-name} is not qualified
